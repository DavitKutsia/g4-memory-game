...
const MemoryGameMenu = () => {
  const [theme, setTheme] = useState("Numbers");
  const [players, setPlayers] = useState(1);
  const [gridSize, setGridSize] = useState("4x4");

  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[#1c2b38]">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-md w-80 text-center">
        ...
        {/* Start Game Button */}
        <button className="w-full bg-orange-500 text-white font-bold py-3 rounded-full mt-3 transition hover:bg-orange-600 hover:scale-105">
          Start Game
        </button>
      </div>
    </div>
